...
:uri-build-status: https://github.com/sonarsource-cfamily-examples/linux-autotools-gh-actions-sq/actions/workflows/main.yml
:img-build-status: https://github.com/sonarsource-cfamily-examples/linux-autotools-gh-actions-sq/actions/workflows/main.yml/badge.svg
